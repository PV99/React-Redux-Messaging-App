...
An instant messaging application with a fully functional front-end interface. Uses React, Javascript, HTML and CSS for a modern user interface and Redux store, reducers, and actions for fully flushed out application state management.   	An instant messaging application with a fully functional front-end interface. Uses React, Javascript, HTML and CSS for a modern user interface and Redux store, reducers, and actions for application state management.
